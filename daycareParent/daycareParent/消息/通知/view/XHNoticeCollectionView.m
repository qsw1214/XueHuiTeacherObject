...
#import "XHNoticeContentViwCell.h"
#import "XHDynamicsPreviewControl.h"

@implementation XHNoticeCollectionView
...
-(instancetype)init
{
    ...
    if (self)
    {
        [self registerClass:[XHNoticeContentViwCell class] forCellWithReuseIdentifier:CellIdentifier];
...
- (XHNoticeContentViwCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    XHNoticeContentViwCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
