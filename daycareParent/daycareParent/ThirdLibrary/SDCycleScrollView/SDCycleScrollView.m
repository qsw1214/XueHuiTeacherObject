...
- (void)initialization
{
    ...
    _backgroundImageView.image=[UIImage imageNamed:@"placeholderImage"];
...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame shouldInfiniteLoop:(BOOL)infiniteLoop imageNamesGroup:(NSArray *)imageNamesGroup withCurrentPageDotImage:(NSString*)currentPageDotImage withPageControlDot:(NSString*)pageControlDot
{
    SDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
    cycleScrollView.infiniteLoop = infiniteLoop;
    cycleScrollView.localizationImageNamesGroup = [NSMutableArray arrayWithArray:imageNamesGroup];
    [cycleScrollView setCurrentPageDotImage:[UIImage imageNamed:currentPageDotImage]];
    [cycleScrollView setPageDotImage:[UIImage imageNamed:pageControlDot]];
    return cycleScrollView;
}
