...
@property (nonatomic,strong) XHClassManageHeaderBoardControl *boardControl;
...
-(void)resetFrame:(CGRect)frame
{
    ...
    //!< “课程表”提示
    [self.weekTipLabel setFrame:CGRectMake(self.boardControl.left, (self.boardControl.bottom+20.0), 60.0, 30.0)];
    //!< 星期滚动条
