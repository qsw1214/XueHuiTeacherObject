...
#import "XHScrollPreviewControl.h"
#import "XHFunctionMenuCell.h"



@interface XHScrollPreviewControl () <UICollectionViewDelegate,UICollectionViewDataSource>


@end


@implementation XHScrollPreviewControl
...
{
    if ([self.deletage respondsToSelector:@selector(scrollPreviewDidSelectItemAtindexObject:)])
    {
        [self.deletage scrollPreviewDidSelectItemAtindexObject:[self.dataArray objectAtIndex:indexPath.row]];
    }
}
